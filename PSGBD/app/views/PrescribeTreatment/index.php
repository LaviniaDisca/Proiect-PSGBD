...
<div class="container">
    ...
    <div class="col-lg-12 well">
        <div class="row">
            <form action="<?php echo URL ?>Treatment/prescribe" method="post">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            <label>Patient ID</label>
                            <input type="text" placeholder="Enter Patient ID Here.." class="form-control" name="patient"
                                   required>
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>Doctor ID</label>
                            <input type="text" placeholder="Enter Doctor ID Here.." class="form-control" name="doctor"
                                   required>
                        </div>
                        <div class="col-sm-6 form-group">
                    ...
                    <div class="form-group">
                        <span class="form-label">Med1</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med1"
                               required>
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med2</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med2">
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med3</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med3">
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med4</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med4">
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med5</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med5">
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med6</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med6">
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med7</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med7">
                    </div>
                    <div class="form-group">
                        <span class="form-label">Med8</span>
                        <input class="form-control" placeholder="Enter Med Name Here.." type="text" name="med8">
                    </div>
