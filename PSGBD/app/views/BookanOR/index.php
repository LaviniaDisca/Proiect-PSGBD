...
<div class="main">
    ...
    <form action="<?php echo URL ?>Book/ Rezerva" method="post">
        <div class="CitireId">
            <div class="input-group flex-nowrap">
                <input type="text" class="form-control" placeholder="Id Medic" aria-label="Id" name="Id" aria-describedby="addon-wrapping" required>
                <input class="form-control" placeholder="Data de inceput operatie" type="date"  name="op_date"  required >
                <span class="form-label">Ora de inceput operatie</span>
                <input class="form-control" type="time"  name="op_date"  required>
                <input type="text" class="form-control" placeholder="Durata operatie" aria-label="Durata" name="Durata" aria-describedby="addon-wrapping" required>
            </div>

            <button type="submit" class="btn btn-dark">Rezerva</button>
        </div>
    </form>
